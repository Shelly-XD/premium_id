...
def banner():
    print '\n'   ___                ______      / _ \_______ __ _  / __/ /  ___  / ___/ __/ -_)  ' \_\ \/ _ \/ -_)/_/  /_/  \__/_/_/_/___/_//_/\__/ )'
    print h + ' >>>' + p + ' IP: ' + k + ip
        ...
        with requests.Session() as (ses_):
                ...
                if user_agent_ == cokiez:
                    ...
                    if '|' in user_agentzz_:
                        ...
                        if ':' in str(lim_dev) or '-' in str(lim_dev):
                            ...
                            try:
                                os.system('del cokiez.txt' if os.name == 'nt' else 'rm -rf cokiez.txt')
                            except:
                                pass
            ...
            try:
                if user_agent_ == cokiez:
                    ...
                    print h + ' [' + k + '13' + h + ']' + p + ' Buka Halaman Login Game Lewat FB'
                    print h + ' [' + k + '14' + h + ']' + a + ' Cek Sesi Hasil Crack Checkpoint'
                    print h + ' [' + k + '15' + h + ']' + d + ' Ganti Tumbal Hasil Crack Live'
                    print h + ' [' + k + '16' + h + ']' + p + ' Exit..' + d
            except:
                print h + ' [' + k + '1' + h + ']' + d + ' Crack from friends list' + k + ' + TTL'
                print h + ' [' + k + '2' + h + ']' + d + ' Crack from Public/Teman dari Teman'
            ...
            try:
                if user_agent_ == cokiez:
                    ...
                    print h + ' [' + k + '17' + h + ']' + p + ' Dapatkan Versi' + h + ' PREMIUM'
            except NameError:
                print h + ' [' + k + '17' + h + ']' + p + ' Dapatkan Versi' + h + ' PREMIUM'

            print garis
            pilih = raw_input(p + ' >>> ' + h + '')
            beli_lisen = a + '\n [!]' + p + ' Upgrade ke versi Premium, dan beli Lisensinya\n     ke Admin! untuk mendapatkan Fitur yg Lengkap\n    ' + k + ' No Whatsapp Admin ' + h + '=> 628812457948' + p
            try:
                if user_agent_ == cokiez:
                    if pilih == '1' and pillih == angka:
                        ttl_.append('dev')
                        user = 'me'
                    ...
                    try:
                        if pilih == '1' or pilih == '2' or pilih == '3' or pilih == '4' or pilih == '5' or pilih == '6' or pilih == '7' or pilih == '8' or pilih == '15':
                            if user_agent_ == cokiez:
                                pass
                            else:
                                pilih = '17'
            ...
            try:
                ...
                if pilih == '17':
                    ...
                    try:
                        ...
                        print k + ' ! ' + p + 'Berikan Tool Key ini ke Admin: ' + h + base64.b64encode(id__)
                        print p + '   Untuk Didaftarkan....'
                        print h + '   ==>' + p + ' Ini No Wa Admin: ' + k + no_
                        print ''
                        try:
                            duit = open('co.txt', 'r')
                            subprocess.check_output(['am', 'start', 'https://wa.me/' + no_ + '?text=*MY%20Tool%20Key:%20' + base64.b64encode(id__) + "*\nAssalamu'alaikum%20Bang,%20Mau%20Beli%20Lisensi%20Tool Facebook Lagi!, Saya udah Melebihi Batas Pemakaian"])
                        except:
                            subprocess.check_output(['am', 'start', 'https://wa.me/' + no_ + '?text=*MY%20Tool%20Key:%20' + base64.b64encode(id__) + "*\nAssalamu'alaikum%20Bang,%20Mau%20Beli%20Lisensi%20Tool%20Facebook!"])

                    except:
                        print a + '\n [!]' + p + ' Silahkan Chat Admin Untuk Beli Lisensi!\n     !Jan lupa Kirim Tool Key ini=> ' + h + base64.b64encode(id__)
